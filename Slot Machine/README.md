...
## Фото устройства
*(Вставьте сюда изображения вашего автомата и победного экрана)*
...
## Автор
Проект разработан для демонстрации возможностей MIK32 Amur и навыков в области встраиваемых систем и графических интерфейсов.
